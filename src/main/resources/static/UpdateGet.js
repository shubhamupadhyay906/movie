		...
		$.ajax({
			...
			success: function(result){
				$.each(result, function(i, director){
					...
					var directorInfo = '<form id=empform_' + director.directorId + ' class="form-inline" style="margin-top:20px;margin-bottom:20px">' +
											'<div class="form-group">'	+
										 		'<label style="margin-left:10px; margin-right:5px">Id: </label>'	+
										 		'<input name="directorId" type="text" class="form-control" value=' + director.directorId  + ' disabled >' +
										 	'</div>' +
										 	'<div class="form-group">'	+
											...
											'<div class="form-group" style="display: none;">' +
										 	...
										 	'<div class="form-group" style="display: none;">' +
										  		...
										  		'<input name="count" type="number" class="form-control"  value=' + director.count +'>' +
										  	'</div>' +
					...
					if(i==0){
						$("#updateFormDirId").val(director.directorId);
